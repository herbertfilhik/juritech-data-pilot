...
function Home() {
  ...
  return (
    ...
    <div className="home-container">
      <h1>Bem-vindo ao JuriTech - Data Pilot</h1>      
      <Link to="/" className="btn btn-primary btn-disabled link-vertical">Menu</Link>
      <Link to="/upload" className={`btn btn-primary link-vertical ${isUploadDisabled ? 'btn-disabled' : ''}`}>Realizar Upload da Operação</Link>
      <Link to="/fluxo" className="btn btn-primary link-vertical">Acompanhar Serviço</Link>
      <Link to="/incluir-excluir" className="btn btn-primary link-vertical">Incluir e Excluir Operação</Link>
      <Link to="/excluiracompservico" className="btn btn-primary link-vertical btn-disabled">Excluir Tabela da Operação</Link>
      <Link to="/logout" className="btn btn-primary link-vertical">Logout</Link>
    </div>
  );
}
